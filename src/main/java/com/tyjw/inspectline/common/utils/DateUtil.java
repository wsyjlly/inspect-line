...
//import com.tyjw.xinjiang.common.Constants;
...
public class DateUtil {
	...
	public static Date DateToDate(Date date,DateStyle dateStyle){
		String str = DateToString(date,dateStyle);
	...
	public static void main(String[] args) {
		/*String begin = "2019-01-01";
		String end =   "2019-01-01 12:30:00";
		Date beginDate = StringToDate(begin);
		Date endDate = StringToDate(end);
		BigDecimal longTime = BigDecimal.valueOf(endDate.getTime()-beginDate.getTime());
		BigDecimal hours =longTime.divide(BigDecimal.valueOf(3600000),2, BigDecimal.ROUND_HALF_UP);
		System.out.println(hours);*/

		Date now = new Date();
		String str = DateToString(now,DateStyle.YYYY_MM_DD);
		System.out.println(str);
		Date last = StringToDate(str+" 23:59:59");
